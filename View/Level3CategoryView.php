...
<body>
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <!--  LEVEL 3 RECIPE CATEGORY JUMBOTRON -->
            <div class="col-md-10">
                <div class="jumbotron jumbotron-fluid">
                    <div class="container">
                        <h1 class="display-4">Level 3 Categories</h1>
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                <div id="card-111382">
                    <div class="card">
                        <div class="card-header">
                            <a href="?ctr=CategoriesController&cmd=dinner"><b>Dinner Recipes</b></a>
                        </div>
                        <div id="card-element-778063" class="collapse show">
                            <div class="card-body">
