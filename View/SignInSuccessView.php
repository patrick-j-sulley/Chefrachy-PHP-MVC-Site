...
<body>
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <!-- SIGN IN SUCCESSFUL NOTIFICATION JUMBOTRON-->
            <div class="col-md-4">
                <div class="jumbotron">
                    <h1 class="display-4">Sign In Successful!</h1>
                    <p class="lead">You have been successfully signed in, press OK to go to the home page.</p>
                    <hr class="my-4">
                    <p class="lead">
