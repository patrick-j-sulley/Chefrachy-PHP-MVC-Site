        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="jumbotron jumbotron-fluid">
                    <div class="container">
                        <h1 class="display-4">Sign Up for Chefrachy</h1>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="signup-form">
                    <div class="main-div">
                        <form id="SignUp" action="./?ctr=SignUpController" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="Email" class="form-control" id="inputEmail" placeholder="Email Address" name="EmailAddr">
                            ...
                            <div class="form-button">
                                <button type="submit" class="btn btn-primary" name="command" value="SignUpSubmit">Sign Up</button>
                            </div>
                        </form>
                    </div>
                </div>
